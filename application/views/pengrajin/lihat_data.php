                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                 <?php echo anchor('pengrajin/post','Tambah Data',array('class'=>'btn btn-info btn-sm')) ?>
                            </div>
                            </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <?php $no=1; foreach ($record->result() as $r) { ?>
                                            <tr class="gradeU">
                                                ...
                                                <td>Rp. <?php echo number_format($r->harga_jasa,2) ?></td>
                                                <td class="center">
                                                <?php echo anchor('pengrajin/edit/'.$r->id_pengrajin,'Edit','class="btn btn-primary"'); ?> 
                                                 <button class="btn btn-danger" name="member" onclick="deletepengrajin('<?php echo $r->id_pengrajin?>')">Delete</button>
                                                </td>
                                            </tr>
                                        <?php $no++; } ?>
                                        </tbody>
...
function deletepengrajin(id)
 {
    $.ajax({
        url  :"<?php echo base_url('pengrajin/delete');?>",
        type : 'POST',
        data : {
            id_pengrajin:id
        },
